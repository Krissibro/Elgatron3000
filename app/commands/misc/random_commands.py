...
class StimCommands(commands.GroupCog, group_name="stim"):
    ...
    async def this_dude(self, ctx: discord.Interaction):
        await send_media(
            ctx,
            "https://tenor.com/view/this-dude-bro-bruh-welcome-to-gamestop-tiktok-gif-21824756",
        )
    ...
    async def pet_elga3(self, ctx: discord.Interaction):
        await send_media(
            ctx,
            "https://media.discordapp.net/attachments/875799818621046855/917046780854685716/5f4877b8-0843-4369-b0dc-0238c230723b.gif?ex=65e47cde&is=65d207de&hm=d79d73354d613b62fdea18fbd782279f980ff19e0d7ad5c4cf51d66094cb655d&",
        )
    ...
    async def thanos_snapped(self, ctx: discord.Interaction):
        await send_media(
            ctx, "https://tenor.com/view/disappointed-snapped-sad-gif-22165289"
        )
    ...
    async def weave(self, ctx: discord.Interaction):
        await send_media(
            ctx,
            "https://cdn.discordapp.com/attachments/839100318893211669/1211047164567093248/weave.mov?ex=65ecc690&is=65da5190&hm=6ba609dcb85e8ccda9ed75850c0686117f0fa6f824bd6073d035c55a487c6131&",
        )
    ...
    async def trout(self, ctx: discord.Interaction):
        await send_media(
            ctx,
            "https://cdn.discordapp.com/attachments/839100318893211669/1211047338509082664/trout.mp4?ex=65ecc6b9&is=65da51b9&hm=53454f3fb04b5ac3c02974211f370897b90e3a1925f4d3e5c0ab5aee9dcd6077&",
        )
    ...
    async def sussy_baki(self, ctx: discord.Interaction):
        await send_media(
            ctx,
            "https://cdn.discordapp.com/attachments/839100318893211669/1245765875462836388/Sossi-baki.mp4?ex=6659f161&is=66589fe1&hm=5af0e663626613c8ef2ab2bb7c0876447eeeedc6194d7aa24f7c80c8dbb95d40&",
        )
    ...
    async def crazy_jorgen_wordle_guess(self, ctx: discord.Interaction):
        await send_media(
            ctx,
            "https://cdn.discordapp.com/attachments/839100318893211669/1463529624368578730/james_doakes_sus.mp4?ex=697229ad&is=6970d82d&hm=2ebdf49d9883e596017095b265acda6b4bc533d055bc20bab93873c9e70e4eb7&",
        )
    ...
    async def help(self, ctx: discord.Interaction):
        await send_media(
            ctx,
            "https://cdn.discordapp.com/attachments/839100318893211669/1310589750490562640/HEEEELP.mp4?ex=6745c552&is=674473d2&hm=86c7673380acaf4bea501ca6cd938ba70da9ed7aa783882fa4445ef98c02ba85&",
        )
    ...
    async def im_losing_it(self, ctx: discord.Interaction):
        await send_media(
            ctx,
            "https://cdn.discordapp.com/attachments/839100318893211669/1463529639015354451/im_losing_it.mp4?ex=697229b1&is=6970d831&hm=f196b15a2310458bfe65b3837b61092e600d6eef0d9fd2f39e4b09f372af9421&",
        )
    ...
    async def wassup_beijing(self, ctx: discord.Interaction):
        await send_media(
            ctx,
            "https://cdn.discordapp.com/attachments/839100318893211669/1310925320014008340/wassup-beijing.mp4?ex=6746fdd8&is=6745ac58&hm=f3e680140b5238a1f6ec58b7c8ba95c7223e1fcc5246028dc7ba797be7d6f128&",
        )
    ...
    async def gn_girl(self, ctx: discord.Interaction):
        await send_media(
            ctx,
            "https://cdn.discordapp.com/attachments/839100318893211669/1310925339765248020/gn-girl.mp4?ex=6746fddc&is=6745ac5c&hm=b4168328e4f76d27e2649dc530bf33b69fcdc60c72a29f54d847bab35ac8b907&",
        )
    ...
    async def dr_peppa(self, ctx: discord.Interaction):
        await send_media(
            ctx,
            "https://cdn.discordapp.com/attachments/839100318893211669/1351897109263290479/dr-peppa.mp4?ex=67dc0bcb&is=67daba4b&hm=3c104e683e6274cd6dccb001ba942fc71dc446c127e3c107fff159b5b456b418&",
        )
    ...
    async def sybau(self, ctx: discord.Interaction):
        await send_media(
            ctx,
            "https://cdn.discordapp.com/attachments/839100318893211669/1463529609092927634/sybau.mp4?ex=697229a9&is=6970d829&hm=9eee151906d8101b13006fee369d379c5db1f71ff11521bc2b28cf1da852c1cb&",
        )
    ...
    async def game_pitch(self, ctx: discord.Interaction):
        await send_media(
            ctx,
            "https://cdn.discordapp.com/attachments/839100318893211669/1463529572115939454/games_pitch.mp4?ex=697229a1&is=6970d821&hm=d80a2a59907c67d132756addcfb51e251ba49104412afc0dc25453ce0a98d37a&",
        )
    ...
    async def crow_honk(self, ctx: discord.Interaction):
        await send_media(
            ctx,
            "https://cdn.discordapp.com/attachments/163382741491122176/1500560584268058674/Crow_honk.mp4?ex=6a1dcb72&is=6a1c79f2&hm=834912f11d8b3869bacc78e12e260a48b3e181ee09ee6d977ffa5f2cfb48b58f&",
        )
    ...
    async def feed_yourself(self, ctx: discord.Interaction):
        await send_media(
            ctx,
            "https://cdn.discordapp.com/attachments/839100318893211669/1498318978634747954/unknown.png?ex=6a1d8cc9&is=6a1c3b49&hm=1e2ddcdb7746d8f6389f8003c27f8c2d214c9402c2c01ed8af6ef91154b51c22&",
        )
    ...
    async def bergen(self, ctx: discord.Interaction):
        await send_media(
            ctx,
            "https://cdn.discordapp.com/attachments/839100318893211669/1510761585440981054/bergen.mp4?ex=6a1dfdde&is=6a1cac5e&hm=417edf043d5da90f1a18d4704acc4ed9364ff7b8de4ebe2ce971702a6aa53bb7&",
        )
    ...
    async def skeleton(self, ctx: discord.Interaction):
        await send_media(
            ctx,
            "https://cdn.discordapp.com/attachments/839100318893211669/1510762628455071784/skeleton.mp4?ex=6a1dfed7&is=6a1cad57&hm=3f0cb0950f3bcde9bb7cd46cb3b79f6d003fb9db95108d9f525dd1f9ec4c3813&",
        )
    ...
    async def fumble(self, ctx: discord.Interaction):
        await send_media(
            ctx, "https://tenor.com/view/basketball-miss-failure-fail-gif-24912602"
        )
...
class SteamAPICommands(commands.Cog):
    ...
    async def tobias_nuke(self, ctx: discord.Interaction):
        ...
        try:
            total_game_hours = self.get_steam_game_hours_played(
                TOBIAS_STEAM_ID, FFXIV_APP_ID
            )
            ...
            if total_game_hours is None:
                await ctx.response.send_message(
                    embed=discord.Embed(
                        title="Couldn't find playtime", color=discord.Color.dark_red()
                    )
                )
                ...
                await ctx.response.send_message(
                    embed=discord.Embed(
                        title=f"Tobias currently has  **{total_game_hours:.0f}**  hours played in Final Fantasy XIV Online",
                        color=discord.Color.red(),
                    )
                )
