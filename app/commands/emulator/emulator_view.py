...
class EmulatorController(discord.ui.View):
    ...
    async def update(
        self, interaction: discord.Interaction, button: str | None, frames: int
    ) -> None:
        # do the emulation
    ...
    @discord.ui.button(
        emoji="🅰️", style=discord.ButtonStyle.red, row=0, custom_id="A_Button"
    )
    async def a_button(
    ...
    @discord.ui.button(
        emoji="🔼", style=discord.ButtonStyle.blurple, row=0, custom_id="Up_Button"
    )
    async def up_button(
        self, interaction: discord.Interaction, button: discord.ui.Button
    ) -> None:
    ...
    @discord.ui.button(
        emoji="🅱️", style=discord.ButtonStyle.red, row=0, custom_id="B_Button"
    )
    async def b_button(
        self, interaction: discord.Interaction, button: discord.ui.Button
    ) -> None:
    ...
    @discord.ui.button(
        emoji="◀️", style=discord.ButtonStyle.blurple, row=1, custom_id="Left_Button"
    )
    ...
    @discord.ui.button(
        emoji="🔽", style=discord.ButtonStyle.blurple, row=1, custom_id="Down_Button"
    )
    ...
    @discord.ui.button(
        emoji="▶️", style=discord.ButtonStyle.blurple, row=1, custom_id="Right_Button"
    )
    ...
    @discord.ui.button(
        emoji="📃", style=discord.ButtonStyle.grey, row=2, custom_id="Select_Button"
    )
    ...
    @discord.ui.button(
        emoji="⌚", style=discord.ButtonStyle.grey, row=2, custom_id="Wait_Button"
    )
    ...
    @discord.ui.button(
        emoji="🔎", style=discord.ButtonStyle.grey, row=2, custom_id="Settings_Button"
    )
